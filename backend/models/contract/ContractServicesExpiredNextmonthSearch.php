...
/**
 * ContractServicesExpiredNextmonthSearch represents the model behind the search form about `backend\models\contract\ContractServicesNextmonth`.
 */
class ContractServicesExpiredNextmonthSearch extends ContractServicesNextmonth
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = ContractServicesNextmonth::find();
