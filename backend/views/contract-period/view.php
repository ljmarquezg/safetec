...
$this->title = $model->id_contract_period;
...
<div class="contract-period-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->id_contract_period], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->id_contract_period], [
