                    ...
                    <div class="widget-user-header bg-green-active">
                        <div class="widget-user-image">
                            ...
                            <div class="onoffswitch" style="left: calc(50% - 50px); top:20px;">
                                ...
                                <?= $form->field($model, 'id_customer_status')->checkbox(array('id'=>'customer', 'class'=>'onoffswitch-checkbox','label' => '','value'=>'1', 'checked'=>'checked'))?>
    ...
    $('form#createmodal-customer').on('beforeSubmit', function(e)
    {
        ...
        .done(function(result){
            if(result==1){
                ...
                $('#message').html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><h4><i class="icon fa fa-check"></i> Customer Saved.</h4>New customer has been Successfully created.</div>')
            }else{
                $('#message').html(result); 
            }
        }).fail(function(){
