...
//$('#phone').html(data.customer_phone);
        $('#customerbranch-crop_info').attr('src', '');
        $('.cropped>.img-thumbnail').attr('src', '');
