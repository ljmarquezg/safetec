...
class CustomerSearch extends Customer
{
    ...
    public function rules()
    {
        return [
            ...
            [['customer_name', 'customer_address', 'customer_address2', 'customer_contact', 'customer_country', 'customer_state', 'customer_zip', 'customer_zone', 'customer_created', 'customer_phone', 'customer_fax', 'customer_email', 'customer_logo'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'customer_name', $this->customer_name])
            ...
            ->andFilterWhere(['like', 'customer_logo', $this->customer_logo]);
