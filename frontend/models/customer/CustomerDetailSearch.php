...
use frontend\models\customer\CustomerDetail;

/**
 * CustomerDetailSearch represents the model behind the search form about `frontend\models\customer\CustomerDetail`.
 */
